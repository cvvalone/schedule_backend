...
Future<Response> _getAll(
  ...
  try {
    ...
    // LEFT JOIN для отримання опціональних назв групи та автора
    ...
    final notifications = result.map((row) {
      ...
      return {
        ...
        'group': rowMap['group_title'] == null ? null : {'title': rowMap['group_title']},
    ...
    return Response.json(body: notifications);
  } catch (e) {
    return Response.json(
      statusCode: 500,
